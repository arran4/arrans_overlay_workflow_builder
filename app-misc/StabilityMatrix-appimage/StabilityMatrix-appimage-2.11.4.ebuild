...
SRC_URI="
  amd64? ( https://github.com/LykosAI/StabilityMatrix/releases/download/v2.11.4/StabilityMatrix-linux-x64.zip -> ${P}-StabilityMatrix-linux-x64.zip )
"
...
src_unpack() {
  ...
  if use amd64; then
    mv "${DESTDIR}/${P}-StabilityMatrix.AppImage" "StabilityMatrix.AppImage"  || die "Can't move archived file"
  fi
