...
SRC_URI="
  amd64? ( https://github.com/WerWolv/ImHex/releases/download/v1.35.4/imhex-1.35.4-x86_64.AppImage -> ${P}-imhex-1.35.4-x86_64.AppImage )
"

src_unpack() {
  if use amd64; then
    cp "${DISTDIR}/${P}-imhex-1.35.4-x86_64.AppImage" "ImHex.AppImage"  || die "Can't copy downloaded file"
  fi
