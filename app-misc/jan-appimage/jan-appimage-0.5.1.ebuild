...
SRC_URI="
  amd64? ( https://github.com/janhq/jan/releases/download/v0.5.1/jan-linux-x86_64-${PV}.AppImage -> ${P}-jan-linux-x86_64-.AppImage )
"

src_unpack() {
  if use amd64; then
    cp "${DISTDIR}/${P}-jan-linux-x86_64-.AppImage" "jan.AppImage"  || die "Can't copy downloaded file"
  fi
